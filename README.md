...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/pyabel-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/pyabel-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/pyabel-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/pyabel-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/pyabel-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/pyabel-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/pyabel/badges/version.svg)](https://anaconda.org/conda-forge/pyabel)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/pyabel/badges/downloads.svg)](https://anaconda.org/conda-forge/pyabel)
